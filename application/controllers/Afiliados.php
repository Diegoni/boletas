...
/*--------------------------------------------------------------------------------  
            Administración de Afiliados: Ajax para armar la tabla en el formulario
 --------------------------------------------------------------------------------*/     
    
    public function afiliados_form()
    {
        $registros    = $this->m_afiliados->getAfiliados($this->_session_data['id_ente'], $this->_session_data['id_usuario']);
        $json         = "";
        ...
        if($registros)
        {
            ...
            foreach ($registros as $row) 
            {
                ...
                $buttons = '<input type='.$type.' value='.$value.' name='.$name.' /> ';
...
/*--------------------------------------------------------------------------------	
 ...
 --------------------------------------------------------------------------------*/	
	...
	public function abm($id = NULL)
	{
		...
		$db['session_tarjetas'] = $this->_session_data['tarjetas'];
