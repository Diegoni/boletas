...
if($session_tarjetas == 1)
{
    $input_codigo = '[99999999]';
}else
{
    $input_codigo = '[99999999999]';
}
...
<form action="#" method="post" class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-sm-5">
			<div class="input-group">
				<input <?php echo completar_tag('codigo', $registro_values, $input_codigo);?> onfocusout="buscar_codigo()" required>
	...
	<div class="form-group">
        <!-- NOMBRE -->
        <?php echo setLabel($this->lang->line('dni'));?>
        <div class="col-sm-5">
            <input <?php echo completar_tag('dni', $registro_values, '[99999999]');?>>
        </div>
        <!-- APELLIDO -->
        <?php echo setLabel($this->lang->line('cuit'));?>
        <div class="col-sm-5">
            <input <?php echo completar_tag('cuit', $registro_values, '[99-99999999-9]');?>>
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <?php
		if($registro){
		    echo '<input '.completar_tag('codigo_postal', $registro_values, 'onlyInt').' >';
		}else{
            echo '<input '.completar_tag('codigo_postal', NULL, 'onlyInt').' disabled>';
        }
		?>
		</div>
