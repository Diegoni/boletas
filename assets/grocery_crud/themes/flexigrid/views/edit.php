...
<div id='main-table-box'>
	...
	<div class="row">
		<div class='col-md-8 col-md-offset-2'>
			<button  id="form-button-save" type='submit' value='<?php echo $this->l('form_update_changes'); ?>' class="btn btn-app"/>
                <i class="fa fa-pencil-square-o"></i>
                <?php echo lang('actualizar_per')?>
			</button>
<?php 	if(!$this->unset_back_to_list) { ?>
			<button type='button' value='<?php echo $this->l('form_save_and_go_back'); ?>' class='btn btn-app' id="save-and-go-back-button"/>
                <i class="fa fa-pencil-square-o"></i>
                <?php echo lang('actualizar')?>
            </button>
			<button type='button' value='<?php echo $this->l('form_cancel'); ?>' class='btn btn-app' id="cancel-button" />
			    <i class="fa fa-ban"></i>
