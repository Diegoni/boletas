...
<div id='main-table-box'>
	<?php echo form_open( $read_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data" class="form-horizontal"'); ?>
		...
		?>
			<div class='form-group <?php echo $even_odd?>' id="<?php echo $field->field_name; ?>_field_box">
				<div class='col-sm-2' id="<?php echo $field->field_name; ?>_display_as_box">
					<b>
